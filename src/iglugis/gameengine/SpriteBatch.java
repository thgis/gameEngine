...
public class SpriteBatch {
   ...
   //--Members--//
   GLGraphics graphics;                                           // GL Instance
   ...
   public SpriteBatch(GLGraphics graphics, int maxSprites)  {
      this.graphics = graphics;                                   // Save GL Instance
      this.vertexBuffer = new float[maxSprites * VERTICES_PER_SPRITE * VERTEX_SIZE];  // Create Vertex Buffer
      this.vertices = new Vertices( graphics, maxSprites * VERTICES_PER_SPRITE, maxSprites * INDICES_PER_SPRITE, false, true, false );  // Create Rendering Vertices
   ...
   // R: [none]
   public void beginBatch(Texture tex)  {
	   tex.bind();
